  ...
  implements GL30
{
  ...
  {
    GLES30.glBlitFramebuffer(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramInt9, paramInt10);
  }

  public void glClearBufferfi(int paramInt1, int paramInt2, float paramFloat, int paramInt3)
  {
    GLES30.glClearBufferfi(paramInt1, paramInt2, paramFloat, paramInt3);
  }

  public void glClearBufferfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer)
  {
    GLES30.glClearBufferfv(paramInt1, paramInt2, paramFloatBuffer);
  }

  public void glClearBufferiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer)
  {
    GLES30.glClearBufferiv(paramInt1, paramInt2, paramIntBuffer);
  }

  public void glClearBufferuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer)
  {
    GLES30.glClearBufferuiv(paramInt1, paramInt2, paramIntBuffer);
  }

  public void glCopyBufferSubData(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    GLES30.glCopyBufferSubData(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
  }
  ...
  {
    GLES30.glInvalidateSubFramebuffer(paramInt1, paramInt2, paramIntBuffer, paramInt3, paramInt4, paramInt5, paramInt6);
  }

  public boolean glIsQuery(int paramInt)
  {
    return GLES30.glIsQuery(paramInt);
  }

  public boolean glIsSampler(int paramInt)
  {
    return GLES30.glIsSampler(paramInt);
  }

  public boolean glIsTransformFeedback(int paramInt)
  {
    return GLES30.glIsTransformFeedback(paramInt);
  }

  public boolean glIsVertexArray(int paramInt)
  {
    return GLES30.glIsVertexArray(paramInt);
  }
  ...
  {
    GLES30.glProgramParameteri(paramInt1, paramInt2, paramInt3);
  }

  public void glReadBuffer(int paramInt)
  {
    GLES30.glReadBuffer(paramInt);
  }

  public void glRenderbufferStorageMultisample(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    GLES30.glRenderbufferStorageMultisample(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
  }
  ...
  {
    GLES30.glTexImage3D(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramInt9, paramInt10);
  }
  ...
  {
    GLES30.glTexSubImage3D(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramInt9, paramInt10, paramInt11);
  }
