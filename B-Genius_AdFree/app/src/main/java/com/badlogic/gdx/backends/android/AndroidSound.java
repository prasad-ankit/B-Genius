  ...
  implements Sound
{
  ...
  public final void pause(long paramLong)
  {
    this.soundPool.pause((int)paramLong);
  }
  ...
  public final void resume(long paramLong)
  {
    this.soundPool.resume((int)paramLong);
  }
  ...
  public final void setPriority(long paramLong, int paramInt)
  {
    this.soundPool.setPriority((int)paramLong, paramInt);
  }
