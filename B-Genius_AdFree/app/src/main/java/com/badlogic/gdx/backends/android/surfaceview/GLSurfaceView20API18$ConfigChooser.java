...
class GLSurfaceView20API18$ConfigChooser
  implements GLSurfaceView.EGLConfigChooser
{
  ...
  public GLSurfaceView20API18$ConfigChooser(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
  ...
  private void printConfig(EGL10 paramEGL10, EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig)
  {
    ...
    if (i < 33)
    {
      ...
      {
        String str2 = GLSurfaceView20API18.TAG;
  ...
  private void printConfigs(EGL10 paramEGL10, EGLDisplay paramEGLDisplay, EGLConfig[] paramArrayOfEGLConfig)
  {
    ...
    String str1 = GLSurfaceView20API18.TAG;
 ...
 * Qualified Name:     com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20API18.ConfigChooser
