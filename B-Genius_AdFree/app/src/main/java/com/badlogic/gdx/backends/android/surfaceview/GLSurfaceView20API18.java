...
public class GLSurfaceView20API18 extends GLSurfaceViewAPI18
{
  ...
  private void init(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    setEGLContextFactory(new GLSurfaceView20API18.ContextFactory());
    if (paramBoolean);
    for (GLSurfaceView20API18.ConfigChooser localConfigChooser = new GLSurfaceView20API18.ConfigChooser(8, 8, 8, 8, paramInt1, paramInt2); ; localConfigChooser = new GLSurfaceView20API18.ConfigChooser(5, 6, 5, 0, paramInt1, paramInt2))
    {
  ...
  public InputConnection onCreateInputConnection(EditorInfo paramEditorInfo)
  {
    ...
    return new GLSurfaceView20API18.1(this, this, false);
  }
 ...
 * Qualified Name:     com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20API18
