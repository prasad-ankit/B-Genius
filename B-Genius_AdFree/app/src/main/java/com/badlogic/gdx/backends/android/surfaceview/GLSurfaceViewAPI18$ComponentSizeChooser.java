...
class GLSurfaceViewAPI18$ComponentSizeChooser extends GLSurfaceViewAPI18.BaseConfigChooser
{
  ...
  public GLSurfaceViewAPI18$ComponentSizeChooser(GLSurfaceViewAPI18 paramGLSurfaceViewAPI18, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    super(paramGLSurfaceViewAPI18, new int[] { 12324, paramInt1, 12323, paramInt2, 12322, paramInt3, 12321, paramInt4, 12325, paramInt5, 12326, paramInt6, 12344 });
 ...
 * Qualified Name:     com.badlogic.gdx.backends.android.surfaceview.GLSurfaceViewAPI18.ComponentSizeChooser
