...
public abstract interface GL30 extends GL20
{
  ...
  public abstract void glBeginQuery(int paramInt1, int paramInt2);
  ...
  public abstract void glBindBufferRange(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  ...
  public abstract void glCopyBufferSubData(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);

  public abstract void glCopyTexSubImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9);

  public abstract void glDeleteQueries(int paramInt, IntBuffer paramIntBuffer);

  public abstract void glDeleteQueries(int paramInt1, int[] paramArrayOfInt, int paramInt2);
  ...
  public abstract void glDrawBuffers(int paramInt, IntBuffer paramIntBuffer);

  public abstract void glDrawElementsInstanced(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);

  public abstract void glDrawRangeElements(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6);

  public abstract void glDrawRangeElements(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, Buffer paramBuffer);

  public abstract void glEndQuery(int paramInt);

  public abstract void glEndTransformFeedback();

  public abstract void glFlushMappedBufferRange(int paramInt1, int paramInt2, int paramInt3);

  public abstract void glFramebufferTextureLayer(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);

  public abstract void glGenQueries(int paramInt, IntBuffer paramIntBuffer);

  public abstract void glGenQueries(int paramInt1, int[] paramArrayOfInt, int paramInt2);
  ...
  public abstract String glGetActiveUniformBlockName(int paramInt1, int paramInt2);

  public abstract void glGetActiveUniformBlockName(int paramInt1, int paramInt2, Buffer paramBuffer1, Buffer paramBuffer2);
  ...
  public abstract Buffer glGetBufferPointerv(int paramInt1, int paramInt2);
  ...
  public abstract void glGetQueryObjectuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);

  public abstract void glGetQueryiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
  ...
  public abstract void glGetUniformIndices(int paramInt, String[] paramArrayOfString, IntBuffer paramIntBuffer);
  ...
  public abstract boolean glIsQuery(int paramInt);
  ...
  public abstract void glProgramParameteri(int paramInt1, int paramInt2, int paramInt3);

  public abstract void glReadBuffer(int paramInt);

  public abstract void glRenderbufferStorageMultisample(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
  ...
  public abstract void glTexImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10);

  public abstract void glTexImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, Buffer paramBuffer);

  public abstract void glTexSubImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11);

  public abstract void glTexSubImage3D(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, Buffer paramBuffer);

  public abstract void glTransformFeedbackVaryings(int paramInt1, String[] paramArrayOfString, int paramInt2);
  ...
  public abstract boolean glUnmapBuffer(int paramInt);
  ...
  public abstract void glVertexAttribIPointer(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
 ...
 * Qualified Name:     com.badlogic.gdx.graphics.GL30
