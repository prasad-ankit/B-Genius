  ...
  implements Disposable
{
  ...
  public Gdx2DPixmap(InputStream paramInputStream, int paramInt)
  {
    ...
    this.pixelPtr = load(this.nativeData, arrayOfByte2, 0, arrayOfByte2.length);
    if (this.pixelPtr == null)
  ...
  {
    Gdx2DPixmap localGdx2DPixmap = new Gdx2DPixmap(this.width, this.height, paramInt);
    localGdx2DPixmap.drawPixmap(this, 0, 0, 0, 0, this.width, this.height);
    dispose();
    this.basePtr = localGdx2DPixmap.basePtr;
    this.format = localGdx2DPixmap.format;
    this.height = localGdx2DPixmap.height;
    this.nativeData = localGdx2DPixmap.nativeData;
    this.pixelPtr = localGdx2DPixmap.pixelPtr;
    this.width = localGdx2DPixmap.width;
  }
  ...
  {
    fillTriangle(this.basePtr, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7);
  }
