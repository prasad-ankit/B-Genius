  ...
  implements Disposable
{
  ...
  static
  {
    indexComparator = new TextureAtlas.1();
  }
  ...
  public NinePatch createPatch(String paramString)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      NinePatch localNinePatch = new NinePatch(localAtlasRegion, arrayOfInt[0], arrayOfInt[1], arrayOfInt[2], arrayOfInt[3]);
      if (localAtlasRegion.pads != null)
        localNinePatch.setPadding(localAtlasRegion.pads[0], localAtlasRegion.pads[1], localAtlasRegion.pads[2], localAtlasRegion.pads[3]);
  ...
  public Array createSprites(String paramString)
  {
  ...
  public void dispose()
  {
    ObjectSet.ObjectSetIterator localObjectSetIterator = this.textures.iterator();
    while (localObjectSetIterator.hasNext())
      ((Texture)localObjectSetIterator.next()).dispose();
    this.textures.clear();
  }
  ...
  public Array findRegions(String paramString)
  {
    Array localArray = new Array();
    int i = this.regions.size;
    for (int j = 0; j < i; j++)
