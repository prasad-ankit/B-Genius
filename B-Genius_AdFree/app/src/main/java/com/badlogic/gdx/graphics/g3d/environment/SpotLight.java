...
public class SpotLight extends BaseLight
{
  ...
  {
    return (paramSpotLight != null) && ((paramSpotLight == this) || ((this.color.equals(paramSpotLight.color)) && (this.position.equals(paramSpotLight.position)) && (this.direction.equals(paramSpotLight.direction)) && (MathUtils.isEqual(this.intensity, paramSpotLight.intensity)) && (MathUtils.isEqual(this.cutoffAngle, paramSpotLight.cutoffAngle)) && (MathUtils.isEqual(this.exponent, paramSpotLight.exponent))));
  }

  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof SpotLight))
      return equals((SpotLight)paramObject);
    return false;
  }
  ...
  {
    return set(paramSpotLight.color, paramSpotLight.position, paramSpotLight.direction, paramSpotLight.intensity, paramSpotLight.cutoffAngle, paramSpotLight.exponent);
  }
 ...
 * Qualified Name:     com.badlogic.gdx.graphics.g3d.environment.SpotLight
