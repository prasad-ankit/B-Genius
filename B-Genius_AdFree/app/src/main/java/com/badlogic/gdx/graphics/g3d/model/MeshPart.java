...
public class MeshPart
{
  ...
  {
    set(paramString, paramMesh, paramInt1, paramInt2, paramInt3);
  }

  public boolean equals(MeshPart paramMeshPart)
  {
    return (paramMeshPart == this) || ((paramMeshPart != null) && (paramMeshPart.mesh == this.mesh) && (paramMeshPart.primitiveType == this.primitiveType) && (paramMeshPart.offset == this.offset) && (paramMeshPart.size == this.size));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    while (!(paramObject instanceof MeshPart));
    return equals((MeshPart)paramObject);
  }

  public void render(ShaderProgram paramShaderProgram)
  {
    this.mesh.render(paramShaderProgram, this.primitiveType, this.offset, this.size);
  }

  public void render(ShaderProgram paramShaderProgram, boolean paramBoolean)
  {
    this.mesh.render(paramShaderProgram, this.primitiveType, this.offset, this.size, paramBoolean);
  }
 ...
 * Qualified Name:     com.badlogic.gdx.graphics.g3d.model.MeshPart
