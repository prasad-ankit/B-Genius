...
final class ParticleShader$Setters$1
  implements BaseShader.Setter
{
  ...
  {
    paramBaseShader.set(paramInt, ParticleShader.TMP_VECTOR3.set(paramBaseShader.camera.direction).crs(paramBaseShader.camera.up).nor());
  }
}

/* Location:           C:\Users\KSHITIZ GUPTA\Downloads\apktool-install-windws\dex2jar-0.0.9.15\dex2jar-0.0.9.15\classes_dex2jar.jar
 * Qualified Name:     com.badlogic.gdx.graphics.g3d.particles.ParticleShader.Setters.1
