...
public class DynamicsModifier$PolarAcceleration extends DynamicsModifier.Angular
{
  ParallelArray.FloatChannel directionalVelocityChannel;

  public DynamicsModifier$PolarAcceleration()
  {
  }

  public DynamicsModifier$PolarAcceleration(PolarAcceleration paramPolarAcceleration)
  {
    super(paramPolarAcceleration);
  }
  ...
  public void update()
  {
    ...
    while (m < j)
    {
      ...
      TMP_V3.set(f5 * f8, f7, f6 * f8).nor().scl(f2);
      ...
      m += this.directionalVelocityChannel.strideSize;
 ...
 * Qualified Name:     com.badlogic.gdx.graphics.g3d.particles.influencers.DynamicsModifier.PolarAcceleration
