  ...
  implements TextureData
{
  ...
  public void consumeCustomData(int paramInt)
  {
    ...
    if (!Gdx.graphics.supportsExtension("GL_OES_compressed_ETC1_RGB8_texture"))
    {
      ...
      Gdx.gl.glTexImage2D(paramInt, 0, localPixmap.getGLInternalFormat(), localPixmap.getWidth(), localPixmap.getHeight(), 0, localPixmap.getGLFormat(), localPixmap.getGLType(), localPixmap.getPixels());
      if (this.useMipMaps)
        MipMapGenerator.generateMipMap(paramInt, localPixmap, localPixmap.getWidth(), localPixmap.getHeight());
      localPixmap.dispose();
