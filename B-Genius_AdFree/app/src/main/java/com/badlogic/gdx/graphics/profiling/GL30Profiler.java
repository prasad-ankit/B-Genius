...
public class GL30Profiler extends GLProfiler
  implements GL30
{
  public final GL30 gl30;

  protected GL30Profiler(GL30 paramGL30)
  {
    this.gl30 = paramGL30;
  }
  ...
  {
    calls = 1 + calls;
    int i = this.gl30.glCheckFramebufferStatus(paramInt);
    check();
    return i;
  }
  ...
  {
    calls = 1 + calls;
    int i = this.gl30.glCreateShader(paramInt);
    check();
    return i;
  }
  ...
  {
    calls = 1 + calls;
    int i = this.gl30.glGetAttribLocation(paramInt, paramString);
    check();
    return i;
  }
  ...
  {
    calls = 1 + calls;
    Buffer localBuffer = this.gl30.glGetBufferPointerv(paramInt1, paramInt2);
    check();
    return localBuffer;
  }
  ...
  {
    calls = 1 + calls;
    int i = this.gl30.glGetFragDataLocation(paramInt, paramString);
    check();
    return i;
  }
  ...
  {
    calls = 1 + calls;
    int i = this.gl30.glGetUniformBlockIndex(paramInt, paramString);
    check();
    return i;
  }
  ...
  {
    calls = 1 + calls;
    int i = this.gl30.glGetUniformLocation(paramInt, paramString);
    check();
    return i;
  }
 ...
 * Qualified Name:     com.badlogic.gdx.graphics.profiling.GL30Profiler
