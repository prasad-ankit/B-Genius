...
{
  public abstract boolean fling(float paramFloat1, float paramFloat2, int paramInt);
  ...
  public abstract boolean panStop(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2);

  public abstract boolean pinch(Vector2 paramVector21, Vector2 paramVector22, Vector2 paramVector23, Vector2 paramVector24);

  public abstract boolean tap(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2);

  public abstract boolean touchDown(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2);
