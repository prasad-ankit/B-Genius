...
{
  public static Action action(Class paramClass)
  {
  ...
  {
    AddAction localAddAction = (AddAction)action(AddAction.class);
    localAddAction.setTarget(paramActor);
    localAddAction.setAction(paramAction);
    return localAddAction;
  }
  ...
  {
    AddListenerAction localAddListenerAction = (AddListenerAction)action(AddListenerAction.class);
    localAddListenerAction.setListener(paramEventListener);
    localAddListenerAction.setCapture(paramBoolean);
    return localAddListenerAction;
  }

  public static AddListenerAction addListener(EventListener paramEventListener, boolean paramBoolean, Actor paramActor)
  {
    AddListenerAction localAddListenerAction = (AddListenerAction)action(AddListenerAction.class);
    localAddListenerAction.setTarget(paramActor);
    localAddListenerAction.setListener(paramEventListener);
    localAddListenerAction.setCapture(paramBoolean);
    return localAddListenerAction;
  }
  ...
  {
    return moveToAligned(paramFloat1, paramFloat2, paramInt, 0.0F, null);
  }

  public static MoveToAction moveToAligned(float paramFloat1, float paramFloat2, int paramInt, float paramFloat3)
  {
    return moveToAligned(paramFloat1, paramFloat2, paramInt, paramFloat3, null);
  }
  ...
  {
    MoveToAction localMoveToAction = (MoveToAction)action(MoveToAction.class);
    localMoveToAction.setPosition(paramFloat1, paramFloat2, paramInt);
    localMoveToAction.setDuration(paramFloat3);
    localMoveToAction.setInterpolation(paramInterpolation);
    return localMoveToAction;
  }
  ...
  {
    RemoveAction localRemoveAction = (RemoveAction)action(RemoveAction.class);
    localRemoveAction.setAction(paramAction);
  ...
  {
    RemoveAction localRemoveAction = (RemoveAction)action(RemoveAction.class);
    localRemoveAction.setTarget(paramActor);
    localRemoveAction.setAction(paramAction);
    return localRemoveAction;
  }
  ...
  public static RemoveActorAction removeActor(Actor paramActor)
  {
    ...
    localRemoveActorAction.setTarget(paramActor);
  ...
  {
    RemoveListenerAction localRemoveListenerAction = (RemoveListenerAction)action(RemoveListenerAction.class);
    localRemoveListenerAction.setListener(paramEventListener);
    localRemoveListenerAction.setCapture(paramBoolean);
    return localRemoveListenerAction;
  }

  public static RemoveListenerAction removeListener(EventListener paramEventListener, boolean paramBoolean, Actor paramActor)
  {
    RemoveListenerAction localRemoveListenerAction = (RemoveListenerAction)action(RemoveListenerAction.class);
    localRemoveListenerAction.setTarget(paramActor);
    localRemoveListenerAction.setListener(paramEventListener);
    localRemoveListenerAction.setCapture(paramBoolean);
    return localRemoveListenerAction;
  }
  ...
  {
    TimeScaleAction localTimeScaleAction = (TimeScaleAction)action(TimeScaleAction.class);
    localTimeScaleAction.setScale(paramFloat);
    localTimeScaleAction.setAction(paramAction);
    return localTimeScaleAction;
  }
