...
public class IntFloatMap$Entries extends IntFloatMap.MapIterator
  implements Iterable, Iterator
{
  private IntFloatMap.Entry entry = new IntFloatMap.Entry();

  public IntFloatMap$Entries(IntFloatMap paramIntFloatMap)
  {
 ...
 * Qualified Name:     com.badlogic.gdx.utils.IntFloatMap.Entries
