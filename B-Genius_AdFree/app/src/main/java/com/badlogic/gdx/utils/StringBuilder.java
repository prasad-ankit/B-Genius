  ...
  implements Appendable, CharSequence
{
  ...
  {
    return append(paramInt1, paramInt2, '0');
  }
  ...
  public StringBuilder append(int paramInt1, int paramInt2, char paramChar)
  {
    ...
    if (paramInt2 > 1)
      for (int i = paramInt2 - numChars(paramInt1, 10); i > 0; i--)
        append(paramChar);
    if (paramInt1 >= 10000)
    {
      if (paramInt1 >= 1000000000)
        append0(digits[(int)(paramInt1 % 10000000000L / 1000000000L)]);
      if (paramInt1 >= 100000000)
        append0(digits[(paramInt1 % 1000000000 / 100000000)]);
      if (paramInt1 >= 10000000)
        append0(digits[(paramInt1 % 100000000 / 10000000)]);
      if (paramInt1 >= 1000000)
        append0(digits[(paramInt1 % 10000000 / 1000000)]);
      if (paramInt1 >= 100000)
        append0(digits[(paramInt1 % 1000000 / 100000)]);
      append0(digits[(paramInt1 % 100000 / 10000)]);
    }
    if (paramInt1 >= 1000)
      append0(digits[(paramInt1 % 10000 / 1000)]);
    if (paramInt1 >= 100)
      append0(digits[(paramInt1 % 1000 / 100)]);
    if (paramInt1 >= 10)
      append0(digits[(paramInt1 % 100 / 10)]);
    append0(digits[(paramInt1 % 10)]);
    return this;
  }

  public StringBuilder append(long paramLong)
  {
    return append(paramLong, 0);
  }

  public StringBuilder append(long paramLong, int paramInt)
  {
    return append(paramLong, paramInt, '0');
  }
  ...
  public StringBuilder append(long paramLong, int paramInt, char paramChar)
  {
    ...
    if (paramInt > 1)
      for (int i = paramInt - numChars(paramLong, 10); i > 0; i--)
        append(paramChar);
    if (paramLong >= 10000L)
    {
      if (paramLong >= 1000000000000000000L)
        append0(digits[(int)(paramLong % 1.0E+019D / 1.0E+018D)]);
      if (paramLong >= 100000000000000000L)
        append0(digits[(int)(paramLong % 1000000000000000000L / 100000000000000000L)]);
      if (paramLong >= 10000000000000000L)
        append0(digits[(int)(paramLong % 100000000000000000L / 10000000000000000L)]);
      if (paramLong >= 1000000000000000L)
        append0(digits[(int)(paramLong % 10000000000000000L / 1000000000000000L)]);
      if (paramLong >= 100000000000000L)
        append0(digits[(int)(paramLong % 1000000000000000L / 100000000000000L)]);
      if (paramLong >= 10000000000000L)
        append0(digits[(int)(paramLong % 100000000000000L / 10000000000000L)]);
      if (paramLong >= 1000000000000L)
        append0(digits[(int)(paramLong % 10000000000000L / 1000000000000L)]);
      if (paramLong >= 100000000000L)
        append0(digits[(int)(paramLong % 1000000000000L / 100000000000L)]);
      if (paramLong >= 10000000000L)
        append0(digits[(int)(paramLong % 100000000000L / 10000000000L)]);
      if (paramLong >= 1000000000L)
        append0(digits[(int)(paramLong % 10000000000L / 1000000000L)]);
      if (paramLong >= 100000000L)
        append0(digits[(int)(paramLong % 1000000000L / 100000000L)]);
      if (paramLong >= 10000000L)
        append0(digits[(int)(paramLong % 100000000L / 10000000L)]);
      if (paramLong >= 1000000L)
        append0(digits[(int)(paramLong % 10000000L / 1000000L)]);
      if (paramLong >= 100000L)
        append0(digits[(int)(paramLong % 1000000L / 100000L)]);
      append0(digits[(int)(paramLong % 100000L / 10000L)]);
    }
    if (paramLong >= 1000L)
      append0(digits[(int)(paramLong % 10000L / 1000L)]);
    if (paramLong >= 100L)
      append0(digits[(int)(paramLong % 1000L / 100L)]);
    if (paramLong >= 10L)
      append0(digits[(int)(paramLong % 100L / 10L)]);
    append0(digits[(int)(paramLong % 10L)]);
    return this;
  }
  ...
  public StringBuilder append(CharSequence paramCharSequence)
  {
    ...
    {
      StringBuilder localStringBuilder = (StringBuilder)paramCharSequence;
      append0(localStringBuilder.chars, 0, localStringBuilder.length);
      return this;
    }
    ...
    if ((paramInt1 >= 0) && (paramInt1 <= paramInt3))
    {
      if ((paramInt2 >= 0) && (paramInt3 >= 0) && (paramInt3 <= paramArrayOfChar.length - paramInt2))
      {
        if (paramInt3 != 0)
        {
          ...
          this.length = (paramInt3 + this.length);
        }
        return;
      }
  ...
  public StringBuilder replace(String paramString1, String paramString2)
  {
    ...
    for (int k = 0; ; k = m + j)
    {
      m = indexOf(paramString1, k);
      if (m == -1)
        break;
      replace0(m, m + i, paramString2);
    }
    return this;
  }
