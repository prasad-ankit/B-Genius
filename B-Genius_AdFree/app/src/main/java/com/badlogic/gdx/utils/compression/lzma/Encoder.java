...
public class Encoder
{
  ...
  int GetOptimum(int paramInt)
  {
    ...
    for (int i5 = i4; ; i5 = i6)
    {
      ...
      while (true)
      {
        ...
        if (this._optimum[i12].Prev1IsChar)
        {
          ...
          if (this._optimum[i12].Prev2)
          {
            ...
            if (this._optimum[i12].BackPrev2 < 4)
            {
              ...
              {
                int i69 = i26 + GetRepLen1Price(i18, i20);
                if (i69 <= localOptimal3.Price)
                {
                  localOptimal3.Price = i69;
                  localOptimal3.PosPrev = i12;
        ...
        label1928: label2081: label2127: label3283: for (int i29 = this._numFastBytes; ; i29 = i28)
        {
          int i30;
          if ((i24 == 0) && (b5 != b4))
          {
            int i62 = Math.min(i28 - 1, this._numFastBytes);
            int i63 = this._matchFinder.GetMatchLen(0, this.reps[0], i62);
            if (i63 >= 2)
            {
              int i64 = Base.StateUpdateChar(i18);
              int i65 = paramInt + 1 & this._posStateMask;
              int i66 = i22 + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice1(this._isMatch[(i65 + (i64 << 4))]) + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice1(this._isRep[i64]);
              int i67 = i63 + (i12 + 1);
              i30 = i11;
              while (true)
                if (i30 < i67)
                {
                  ...
                  break;
                  i71 = this._optimum[i70].State;
                  break;
                  i16 = this._optimum[i15].State;
                  break label1147;
                  label1756: i18 = Base.StateUpdateChar(i16);
                  break label1176;
                  label1766: int i17;
              ...
              int i68 = i66 + GetRepPrice(0, i63, i64, i65);
              Encoder.Optimal localOptimal8 = this._optimum[i67];
              if (i68 < localOptimal8.Price)
              {
                localOptimal8.Price = i68;
          ...
          while (true)
          {
            ...
            while (i31 < 4)
            {
              int i49 = this._matchFinder.GetMatchLen(-1, this.reps[i31], i29);
              if (i49 >= 2)
              {
                int i50 = i49;
                do
                {
                  while (i30 < i12 + i50)
                  {
                    ...
                    i30++;
                    arrayOfOptimal5[i30].Price = 268435455;
                  }
                  int i51 = i26 + GetRepPrice(i31, i50, i18, i20);
                  Encoder.Optimal localOptimal6 = this._optimum[(i12 + i50)];
                  if (i51 < localOptimal6.Price)
                  {
                    localOptimal6.Price = i51;
                ...
                if (i49 < i28)
                {
                  int i52 = Math.min(i28 - 1 - i49, this._numFastBytes);
                  int i53 = this._matchFinder.GetMatchLen(i49, this.reps[i31], i52);
                  if (i53 >= 2)
                  {
                    int i54 = Base.StateUpdateRep(i18);
                    int i55 = paramInt + i49 & this._posStateMask;
                    int i56 = i26 + GetRepPrice(i31, i49, i18, i20) + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice0(this._isMatch[(i55 + (i54 << 4))]) + this._literalEncoder.GetSubCoder(paramInt + i49, this._matchFinder.GetIndexByte(-1 + (i49 - 1))).GetPrice(true, this._matchFinder.GetIndexByte(i49 - 1 - (1 + this.reps[i31])), this._matchFinder.GetIndexByte(i49 - 1));
                    int i57 = Base.StateUpdateChar(i54);
                    int i58 = 1 + (paramInt + i49) & this._posStateMask;
                    int i59 = i56 + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice1(this._isMatch[(i58 + (i57 << 4))]) + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice1(this._isRep[i57]);
                    int i60 = i53 + (i49 + 1);
                    while (i30 < i12 + i60)
                    {
                      Encoder.Optimal[] arrayOfOptimal4 = this._optimum;
                      i30++;
                      arrayOfOptimal4[i30].Price = 268435455;
                    }
                    int i61 = i59 + GetRepPrice(0, i53, i57, i58);
                    Encoder.Optimal localOptimal7 = this._optimum[(i12 + i60)];
                    if (i61 < localOptimal7.Price)
                    {
                      localOptimal7.Price = i61;
                      localOptimal7.PosPrev = (1 + (i12 + i49));
            ...
            if (i13 > i29)
            {
              for (i48 = 0; i29 > this._matchDistances[i48]; i48 += 2);
              this._matchDistances[i48] = i29;
            }
            for (int i33 = i48 + 2; ; i33 = i14)
            {
              if (i29 >= i32)
              {
                int i34 = i25 + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice0(this._isRep[i18]);
                i11 = i30;
                while (i11 < i12 + i29)
                {
                ...
                for (int i35 = 0; i32 > this._matchDistances[i35]; i35 += 2);
                while (true)
                {
                  int i39;
                  int i47 = i45 + GetRepPrice(0, i39, i43, i44);
                  Encoder.Optimal localOptimal5 = this._optimum[(i12 + i46)];
                  int i36;
                  if (i47 < localOptimal5.Price)
                  {
                    localOptimal5.Price = i47;
                    localOptimal5.PosPrev = (1 + (i12 + i32));
                    localOptimal5.BackPrev = 0;
                    localOptimal5.Prev1IsChar = true;
                    localOptimal5.Prev2 = true;
                    localOptimal5.PosPrev2 = i12;
                    localOptimal5.BackPrev2 = (i36 + 4);
                  }
                  int i37;
                  do
                  {
                    do
                    {
                      ...
                      {
                        i32++;
                        i36 = this._matchDistances[(i35 + 1)];
                        i37 = i34 + GetPosLenPrice(i36, i32, i20);
                        Encoder.Optimal localOptimal4 = this._optimum[(i12 + i32)];
                        if (i37 >= localOptimal4.Price)
                          continue;
                        localOptimal4.Price = i37;
                        localOptimal4.PosPrev = i12;
                        localOptimal4.BackPrev = (i36 + 4);
                        localOptimal4.Prev1IsChar = false;
                      }
                      while (i32 != this._matchDistances[i35]);
                    }
                    while (i32 >= i28);
                    int i38 = Math.min(i28 - 1 - i32, this._numFastBytes);
                    i39 = this._matchFinder.GetMatchLen(i32, i36, i38);
                  }
                  while (i39 < 2);
                  int i40 = Base.StateUpdateMatch(i18);
                  int i41 = paramInt + i32 & this._posStateMask;
                  int i42 = i37 + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice0(this._isMatch[(i41 + (i40 << 4))]) + this._literalEncoder.GetSubCoder(paramInt + i32, this._matchFinder.GetIndexByte(-1 + (i32 - 1))).GetPrice(true, this._matchFinder.GetIndexByte(-1 + (i32 - (i36 + 1))), this._matchFinder.GetIndexByte(i32 - 1));
                  int i43 = Base.StateUpdateChar(i40);
                  int i44 = 1 + (paramInt + i32) & this._posStateMask;
                  int i45 = i42 + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice1(this._isMatch[(i44 + (i43 << 4))]) + com.badlogic.gdx.utils.compression.rangecoder.Encoder.GetPrice1(this._isRep[i43]);
                  int i46 = i39 + (i32 + 1);
                  while (i11 < i12 + i46)
                  {
  ...
  int GetPosLenPrice(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt1 < 128);
    for (int j = this._distancesPrices[(paramInt1 + (i << 7))]; ; j = this._posSlotPrices[((i << 6) + GetPosSlot2(paramInt1))] + this._alignPrices[(paramInt1 & 0xF)])
