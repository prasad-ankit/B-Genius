...
public abstract class Viewport
{
  ...
  {
    ScissorStack.calculateScissors(this.camera, this.screenX, this.screenY, this.screenWidth, this.screenHeight, paramMatrix4, paramRectangle1, paramRectangle2);
  }
  ...
  {
    return this.camera.getPickRay(paramFloat1, paramFloat2, this.screenX, this.screenY, this.screenWidth, this.screenHeight);
  }
  ...
  {
    update(paramInt1, paramInt2, false);
  }
 ...
 * Qualified Name:     com.badlogic.gdx.utils.viewport.Viewport
