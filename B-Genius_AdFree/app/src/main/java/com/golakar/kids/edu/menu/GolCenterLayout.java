 ...
 * 
 */
public class GolCenterLayout extends ViewGroup {
    /**
    ...
    public GolCenterLayout(Context context) {
        super(context);
    }

    public GolCenterLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.GolCenterLayout, 0, 0);
            mFromDegrees = a.getFloat(R.styleable.GolCenterLayout_fromDegrees, DEFAULT_FROM_DEGREES);
            mToDegrees = a.getFloat(R.styleable.GolCenterLayout_toDegrees, DEFAULT_TO_DEGREES);
            mChildSize = Math.max(a.getDimensionPixelSize(R.styleable.GolCenterLayout_childSize, 0), 0);
    ...
    private static Animation createExpandAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,
        ...
        Animation animation = new MenuAnimation(0, toXDelta, 0, toYDelta, 0, 720);
    ...
    private static Animation createShrinkAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,
        ...
        Animation translateAnimation = new MenuAnimation(0, toXDelta, 0, toYDelta, 360, 720);
