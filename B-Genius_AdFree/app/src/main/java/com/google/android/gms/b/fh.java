...
public abstract class fh extends Binder
  implements fg
{
  public static fg a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof fg)))
      return (fg)localIInterface;
    return new fi(paramIBinder);
  }
 ...
 * Qualified Name:     com.google.android.gms.b.fh
