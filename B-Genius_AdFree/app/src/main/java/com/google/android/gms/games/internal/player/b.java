...
public final class b
{
  ...
  public b(String paramString)
  {
    ...
    new StringBuilder().append(paramString).append("has_all_public_acls");
    this.r = (paramString + "is_profile_visible");
    ...
    this.x = (paramString + "most_recent_game_featured_uri");
    this.y = (paramString + "has_debug_access");
    this.z = (paramString + "gamer_tag");
    this.A = (paramString + "real_name");
    this.B = (paramString + "banner_image_landscape_uri");
    this.C = (paramString + "banner_image_landscape_url");
    this.D = (paramString + "banner_image_portrait_uri");
    this.E = (paramString + "banner_image_portrait_url");
  }
}
